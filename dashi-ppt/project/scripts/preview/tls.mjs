...
export function ensureCertificate({ certDir, certMetaFile, certKeyFile, certFile, localHostname, lanIps, opensslPath }) {
  ...
  if (!opensslPath) {
    throw new Error('OpenSSL executable not found and the cached localhost certificate does not match this machine. Set OPENSSL_PATH and rerun the preview command.');
  }
